...
int main() {
    ...
    // Versión clásica
    int resultado_clasico = sumaMM_clasico(v, 0, n);
    printf("Suma sin máximo ni mínimo (clásico): %d\n", resultado_clasico);
    
    // Versión recursiva
    int resultado_recursivo = sumaMM(v, 0, n - 1);
    printf("Suma sin máximo ni mínimo (recursivo): %d\n", resultado_recursivo);
