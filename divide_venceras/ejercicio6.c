...
int main() {
    ...
    int posicion = 3; // Queremos el tercer corredor con más agua

    corredor resultado = corredor_mas_agua(v, 0, n - 1, posicion);
    
    printf("El corredor con dorsal %d ha llevado la mayor cantidad de agua: %d\n", 
           resultado.dorsal, resultado.cantidad_agua);
