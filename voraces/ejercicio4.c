...
int main() {
    int n = 5; // Número de bombillas
    int m = 3; // Bombillas necesarias para iluminar la habitación

    // Crear un arreglo de bombillas
    bombilla bombillas[] = {
        {1, 10},
        {2, 20},
        {3, 15},
    ...
    int *orden = iluminacion_continua(bombillas, n, m);
